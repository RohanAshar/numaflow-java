...
public class Server {
     ...
     *
     * @param flatMapper to process the message
     */
    public Server(FlatMapper flatMapper) {
        this(flatMapper, GRPCConfig.defaultGrpcConfig());
    }
     ...
     * @param flatMapper to process the message
     */
    public Server(FlatMapper flatMapper, GRPCConfig grpcConfig) {
        this.service = new Service(flatMapper);
